...
if __name__ == "__main__":
    ...
    parser.add_argument("--deact-redistribute", choices=["none", "renorm", "system", "system_only", "vision", "vision_only", "sysvis"], default="none")
    parser.add_argument("--deact-renorm", dest="deact_renorm", action="store_true")
    parser.add_argument("--no-deact-renorm", dest="deact_renorm", action="store_false")
    parser.set_defaults(deact_renorm=False)
