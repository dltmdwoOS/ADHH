...
def load_selected_heads(head_file, topk, score_key="score", score_normalize="minmax"):
    ...
    if isinstance(data, dict):
        if "heads" in data and isinstance(data["heads"], list):
            ...
            score_records = records if score_normalize == "logminmax" else top
...
if __name__ == "__main__":
    ...
    parser.add_argument("--intervention", type=str, default="adhh",
                        choices=["none", "adhh", "soft"])
