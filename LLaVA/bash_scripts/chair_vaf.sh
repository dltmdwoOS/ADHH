...
result_path=${RESULT_PATH:-${results_root}/${dataset}/${model_name}/baselines/vaf/tok${max_new_tokens}/enh${enh_para}_sup${sup_para}_l${start_layer}-${end_layer}}
mkdir -p "${result_path}"
...
if [[ "${dry_run}" == "true" ]]; then
  echo "[dry-run] CHAIR VAF would write -> ${result_path}"
...
echo "CHAIR VAF done -> ${result_path}"
